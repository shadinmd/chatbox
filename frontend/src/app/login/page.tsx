...
const inputStyle: className = "rounded-lg text-black px-2 py-2 focus:outline-none w-full border-2 border-custom-blue"
...
const Login = () => {
	...
	return (
		<div className="flex flex-col gap-7 items-center justify-center h-screen w-screen bg-chat-black text-white">
			<Navbar />
			<div className="flex flex-col gap-7 h-full justify-center mb-8">
				<h1 className="text-5xl font-extrabold text-center text-custom-blue">Login</h1>
				<form
				...
				>
					...
					<button
						type="submit"
						className="rounded-lg bg-custom-red mt-2 w-full py-2 font-bold"
					>
						Login
					</button>
					...
					<Link href={"/forgot"} className="text-custom-blue font-bold">
						forgot password?
					</Link>
				</form>
			</div>
